...
def load_generator_discriminator(DATA, OPTIMIZATION, MODEL, STYLEGAN, MODULES, RUN, effective_num_samples_lambda, device, logger):
    if device == 0:
    ...
    if MODEL.backbone in ["stylegan2", "stylegan3"]:
        if STYLEGAN.channel_base is None and STYLEGAN.channel_max is None:
            ...
            channel_base, channel_max = STYLEGAN.channel_base, STYLEGAN.channel_max
        ...
        if MODEL.backbone == "stylegan2":
            Gen = module.Generator(z_dim=MODEL.z_dim,
                                ...
                                mapping_kwargs={"num_layers": STYLEGAN.mapping_network, 
                                                "add_emb_noise": MODEL.add_emb_noise, "effective_num_samples_lambda": effective_num_samples_lambda,
                                                "emb_noise_std" :MODEL.emb_noise_std},
            ...
            Gen = module.Generator(z_dim=MODEL.z_dim,
                                ...
                                img_channels=DATA.img_channels,
                                MODEL=MODEL,
                                mapping_kwargs={"num_layers": STYLEGAN.mapping_network, "add_emb_noise": MODEL.add_emb_noise, 
                                                "effective_num_samples_lambda": effective_num_samples_lambda, "emb_noise_std" :MODEL.emb_noise_std},
        ...
        Dis = module.Discriminator(c_dim=dis_c_dim,
                                   ...
                                   block_kwargs={},
                                   mapping_kwargs={"add_emb_noise": MODEL.add_emb_noise, "effective_num_samples_lambda": effective_num_samples_lambda,
                                                    "emb_noise_std" :MODEL.emb_noise_std},
                                   epilogue_kwargs={
